...
if __name__ == "__main__":
    folder = Path(r"C:\Users\i.danilov\Desktop\В работе\вахта 3\TQ-12520-00\03.Result2\Replace")
    ...
    RESET_PATTERN_PREFIX = "05_7"  # префикс уже проставленной нумерации, которую нужно откатить
